...
plot(x,y,'LineWidth',1.5)
text(0.09, 0.8, 'VL', 'FontSize', 10, 'Color', [0, 0.4470, 0.7410]);
text(0.24, 0.8, 'L', 'FontSize', 10, 'Color', [0.8500, 0.3250, 0.0980]);
text(0.49, 0.8, 'M', 'FontSize', 10, 'Color', [0.9290, 0.6940, 0.1250]);
text(0.74, 0.8, 'H', 'FontSize', 10, 'Color', [0.4940, 0.1840, 0.5560]);
text(0.89, 0.8, 'VH', 'FontSize', 10, 'Color', [0.4660, 0.6740, 0.1880]);
ylabel('');
xlabel('SoC (%/100)')
...
[x,y] = plotmf(ev,'input',2);
plot(x,y,'LineWidth',1.5)
text(0.01, 0.5, 'VL', 'FontSize', 10, 'Color', [0, 0.4470, 0.7410]);
text(0.03, 0.8, 'L', 'FontSize', 10, 'Color', [0.8500, 0.3250, 0.0980]);
text(0.3, 0.8, 'M', 'FontSize', 10, 'Color', [0.9290, 0.6940, 0.1250]);
text(0.77, 0.8, 'H', 'FontSize', 10, 'Color', [0.4940, 0.1840, 0.5560]);
text(0.91, 0.8, 'VH', 'FontSize', 10, 'Color', [0.4660, 0.6740, 0.1880]);
ylabel('');
xlabel('SoC (%/100)')
...
[x,y] = plotmf(ev,'input',1);
plot(x,y,'LineWidth',1.5)
text(-60, 0.8, 'VL', 'FontSize', 10, 'Color', [0, 0.4470, 0.7410]);
text(-20, 0.8, 'L', 'FontSize', 10, 'Color', [0.8500, 0.3250, 0.0980]);
text(50, 0.8, 'M', 'FontSize', 10, 'Color', [0.9290, 0.6940, 0.1250]);
text(205, 0.8, 'H', 'FontSize', 10, 'Color', [0.4940, 0.1840, 0.5560]);
text(290, 0.8, 'VH', 'FontSize', 10, 'Color', [0.4660, 0.6740, 0.1880]);
ylabel('');
xlabel('Spot Price ($/MWh)')
...
text(0.01, 0.5, 'VL', 'FontSize', 10, 'Color', [0, 0.4470, 0.7410]);
text(0.03, 0.8, 'L', 'FontSize', 10, 'Color', [0.8500, 0.3250, 0.0980]);
text(0.35, 0.8, 'M', 'FontSize', 10, 'Color', [0.9290, 0.6940, 0.1250]);
text(0.7, 0.8, 'H', 'FontSize', 10, 'Color', [0.4940, 0.1840, 0.5560]);
text(0.95, 0.8, 'VH', 'FontSize', 10, 'Color', [0.4660, 0.6740, 0.1880]);
ylabel('');
xlabel('SoC (%/100)')
...
text(-7.5, 0.8, 'N', 'FontSize', 10, 'Color', [0.8500, 0.3250, 0.0980]);
text(-1, 0.8, 'Z', 'FontSize', 10, 'Color', [0.9290, 0.6940, 0.1250]);
text(4.7, 0.8, 'P', 'FontSize', 10, 'Color', [0.4940, 0.1840, 0.5560]);
text(10.5, 0.8, 'HP', 'FontSize', 10, 'Color', [0.4660, 0.6740, 0.1880]);
ylabel('');
xlabel('Power (kW)')